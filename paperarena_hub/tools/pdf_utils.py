...
if __name__ == '__main__':
    ...
    """If you cannot download models due to network issues, you can set the environment variable MINERU_MODEL_SOURCE to modelscope to use the modelscope repository without proxy"""
